 ...
 */
__device__ void single_block_decrypt(uint8_t* state_matrix, uint8_t* __restrict__ iv, const uint8_t* __restrict__ key) { 
...
kernel_hack(uint8_t* __restrict__ device_ciphertext, uint8_t* __restrict__ device_plaintext, uint8_t* __restrict__ device_cbc_iv, size_t iter_num, uint8_t* __restrict__ device_key_to_hack, uint8_t* device_return_key, uint64_t number_of_key_for_thread) {
...
int main() {
    ...
    size_t selected_number_of_thread_per_block = 512;
